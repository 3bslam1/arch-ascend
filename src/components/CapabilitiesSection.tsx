...
const CapabilitiesSection = () => {
  ...
  return (
    <section id="capabilities" className="section-padding bg-secondary/20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {capabilities.map((capability, index) => (
            <div
              ...
              className="group relative p-6 rounded-xl bg-card/50 border border-border/30 hover:border-primary/40 hover:bg-card transition-all duration-300"
